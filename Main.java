...
public class Main {
    public static void main(String[] args) {
        ...
        EventProcess eventProcess1 = new EventProcess(1, "Process1", 5, 3);
        EventProcess eventProcess2 = new EventProcess(1, "Process2", 5, 3);
        EventProcess eventProcess3 = new EventProcess(1, "Process3", 5, 3);
